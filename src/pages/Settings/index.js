...
const Settings = () => {
  ...
  const settingsCards = {
    ...
    master: [
      ...
      {
        module: "ManageSymstoms",
        title: "Manage Symstoms",
        icon: FaCog,
        color: colors[3],
        id: 8,
        isActive: 1,
      ...
      {
        module: "ManageRxTemplate",
        title: "Manage Rx Template",
        icon: FaFileAlt,
        color: colors[4],
        id: 9,
        isActive: 1,
      ...
      {
        module: "ManageDentalChart",
        title: "Manage Dental Chart",
        icon: FaTeeth,
        color: colors[5],
        id: 10,
        isActive: 1,
      ...
      {
        module: "ManageCommunicationGroup",
    ...
    communication: [
      ...
      {
        module: "SMSTemplate",
        title: "Whastapp Template",
        icon: FaSms,
        color: colors[1],
        id: 17,
        isActive: clinic?.whatsapp || 1,
      },
      {
  ...
  const categories = [
    ...
    {
      id: "communication",
      title: "Notification & Reminder Config",
      icon: FaComments,
      color: "info",
    },
  ]
          ...
          {selectedSubCategory ? (
                ...
                <Card>
                  <CardBody>
                    <h5 className="card-title mb-3">
                      ...
                      {
                        categories.find(
                          v => v.id == selectedSubCategory?.parent
                        )?.title
                      }
                    </h5>
                    <ListGroup flush>
                      {selectedSubCategory?.child
                        ...
                        .map(category => (
                          ...
                          >
                            <category.icon
                              className={`me-3 text-${category.color}`}
                            />
              ...
              <Col lg={9}>
                ...
                <Suspense fallback={<div>Loading...</div>}>
                  {(() => {
                    const Component =
                      componentMap[
                        selectedSubCategory.child.find(c => c.selected).module
                      ]
            ...
            <Row>
              ...
              <Col lg={9}>
                ...
                <Row>
                  {settingsCards[selectedCategory]
                    .filter(v => v.isActive)
                    .map(card => {
                      return (
                        <Col
                          onClick={() =>
                            handleCardClick(card, selectedCategory)
                          }
                          md={3}
                          key={card.id}
                          className="mb-4"
