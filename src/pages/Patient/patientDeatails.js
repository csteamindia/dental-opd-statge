    ...
    <React.Fragment>
      <div className="page-content">
        ...
        <Container fluid>
          ...
          <PatientProfile data={patientData} configData={JSON.parse(cookieHelper.getCookie('authUser'))} callback={setIsPatinetSummary} />
          <Tabs patientData={patientData} configData={JSON.parse(cookieHelper.getCookie('authUser'))} role={role} />
        </Container>
      </div>
    </React.Fragment>
  )
