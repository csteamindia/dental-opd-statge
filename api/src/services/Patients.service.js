...
const { Allergies, Doctors, Patients, Clinics, User, Patient_Notes, Patient_Follow_Up, Investigation, Examinations, DentalChart, Tretment, Prescription, Appointment, CommunicationGroup } = db;
